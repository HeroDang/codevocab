...
class FlashcardViewModel(
    ...
    fun markKnown(flashcardId: String, isKnown: Boolean, moduleId: String) {
        viewModelScope.launch {
    ...
    // ✅ Thêm hàm để lấy số từ đã học (phục vụ tính năng Resume)
    suspend fun getProcessedCount(moduleId: String): Int {
        return flashRepo.countByModule(moduleId)
    }
}